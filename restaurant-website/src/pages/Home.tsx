...
export const Home: React.FC = () => {
  ...
  const featuredDishes = [
    {
      ...
      description: "Signature 8-inch pizza loaded with a special mix of fresh veggies, spiced chicken, and double bubbling mozzarella.",
      price: 219,
    ...
    },
    {
      id: "fd2",
      name: "Popcorn (Large)",
      description: "Crispy bite-sized pieces of fresh chicken breast seasoned in our signature secret spices blend. Perfect for sharing.",
      price: 329,
    ...
    },
    {
      id: "fd3",
      name: "Burger Combo",
      description: "Gourmet juicy burger served with a crispy portion of hot golden French fries and a refreshing mocktail.",
      price: 209,
    ...
    },
    {
      ...
      description: "Creamy, rich milkshake blended with crushed Oreos and finished with a delicious chocolate brownie slice.",
      price: 100,
  ...
  const testimonials = [
    {
      ...
      text: "We try this delicious food not only another fried chickens this ultimate and fabulous food this entirely crunchy of chicken items I would like him ... Thanks to fry daddy",
      stars: 5,
    },
    {
      name: "Sri Kanth Parimi",
      role: "Vinukonda Foodie",
      text: "Absolutely loved the variety and taste at Fry Daddy! Whether you're craving crispy fried chicken, juicy burgers, loaded pizzas, or refreshing mocktails – this place has it all. The combo packs are super value for money, and the ice creams and milkshakes are just the perfect finish to a hearty meal.",
      stars: 5,
    },
    {
      name: "Anil Kumar",
      role: "Vinukonda Foodie",
      text: "The Chicken Cheese Burger and Wings Combo are personal favorites – full of flavor and served fresh. Also loved the Mint Mojito and Choco Chip Brownie Shake – so refreshing and indulgent! Great service, quick prep time, and clean ambiance. Must-visit if you're in the area",
      stars: 5,
    }
  ];

  const instaGrid = [
    "Favicon.jpg", // dining room
    "Image8.jpg", // bar counter
    "Image6.jpg", // cocktails
    "Image4.jpg", // wine cellars
    "Image3.jpg", // chef cooking
    "Image5.jpg", // desserts
  ];
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* 2. Stats Section */}
      <section className={`py-16 transition-colors duration-500 border-b ${theme === "dark" ? "bg-stone-950 border-stone-900" : "bg-white border-stone-100"
        }`}>
      ...
      <section className={`py-24 transition-colors duration-500 ${theme === "dark" ? "bg-stone-950" : "bg-stone-50"
        }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className={`py-24 transition-colors duration-500 ${theme === "dark" ? "bg-stone-950" : "bg-stone-50"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Combo 1 */}
            <div className={`overflow-hidden rounded-2xl border flex flex-col md:flex-row hover:scale-[1.01] transition-transform duration-300 ${theme === "dark" ? "bg-stone-900 border-stone-850" : "bg-white border-stone-200"
              }`}>
              <div className="md:w-2/5 relative h-56 md:h-auto min-h-[220px] overflow-hidden">
                <img
                  src="menu/veg_combo.png"
                  alt="Fry Daddy Veg Combo"
                  className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                />
                <div className="absolute top-4 left-4 py-1 px-2.5 rounded bg-emerald-500 text-white text-[10px] font-bold uppercase tracking-wider shadow">
                  Veg
                </div>
              </div>
              <div className="md:w-3/5 p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="font-sans text-xs dark:text-stone-400 text-stone-650 leading-relaxed">
                    Feast of 1 small personal Veg Pizza, French fries, 1 Veg Sandwich, and 1 Veg Burger. Ideal Veg feast for sharing!
                  </p>
                </div>
                <div className="flex items-center justify-between mt-6 pt-6 border-t dark:border-stone-800 border-stone-100">
                  <span className="font-serif text-lg text-gold-500 font-bold">₹299</span>
                  <button
                    onClick={() => setActiveTab("menu")}
            ...
            <div className={`overflow-hidden rounded-2xl border flex flex-col md:flex-row hover:scale-[1.01] transition-transform duration-300 ${theme === "dark" ? "bg-stone-900 border-stone-850" : "bg-white border-stone-200"
              ...
              <div className="md:w-3/5 p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="font-sans text-xs dark:text-stone-400 text-stone-650 leading-relaxed">
                    2 crispy legs served with golden French fries and a refreshing mocktail. Complete meal in itself!
                  </p>
                </div>
                <div className="flex items-center justify-between mt-6 pt-6 border-t dark:border-stone-800 border-stone-100">
                  <span className="font-serif text-lg text-gold-500 font-bold">₹259</span>
                  <button
                    onClick={() => setActiveTab("menu")}
                    className="px-5 py-2.5 bg-stone-950 text-gold-500 hover:bg-gold-500 hover:text-stone-950 border border-gold-500/35 hover:border-gold-500 font-sans font-bold text-xs uppercase tracking-wider rounded transition-all cursor-pointer"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, idx) => (
              <div
                key={idx}
                className={`p-8 rounded-xl border flex flex-col justify-between ${theme === "dark" ? "bg-stone-900 border-stone-850" : "bg-stone-50 border-stone-200"
                  }`}
              >
                <div>
      ...
      <section className={`py-24 transition-colors duration-500 border-t ${theme === "dark" ? "bg-stone-950 border-stone-900" : "bg-white border-stone-100"
        }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-4 font-sans text-sm leading-relaxed">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="dark:text-stone-400 text-stone-600">+91 8125338776</p>
                  </div>
                </div>
